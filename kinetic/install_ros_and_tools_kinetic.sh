...
echo -e "\e[1m \e[34m >>> Installing support software \e[21m \e[39m"
  ...
  sudo apt-get update
  sudo apt-get --yes --allow install sublime-text-installer 
